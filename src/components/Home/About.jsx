...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "I found this garage at a simple search on google, looking for a reliable and professional garage. Since then I’m a regular customer not only for anual services but for any mechanical issues, even road assistance. I truly recommend Dorian and the team. Well done boys and see you soon!",
    name: "Vasilica Andreea",
  },
